...
See the (sorry, kinda boring) "demo map":/OverlappingMarkerSpiderfier/demo.html.

h2. Download

Download "the compiled, minified JS source":/OverlappingMarkerSpiderfier/bin/oms.min.js.

h2. How to use

See the "demo map source":/jawj/OverlappingMarkerSpiderfier/blob/gh-pages/demo.html, or follow along here for added commentary.
