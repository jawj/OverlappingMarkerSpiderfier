...
That might be what you want. However, it probably *isn't* what you want (or, at least, the only thing you want) if you have markers that are in the exact same location, or are close enough to overlap even at the maximum zoom level. In that case, clustering won't help your users pick out (and find out more about) the marker they want.

I'm told that the OverlappingMarkerSpiderfier plays nice with clustering -- i.e. once you get down to a level where individual markers are shown, these markers spiderfy happily -- but I haven't yet tried it myself.
...
Removes every @marker@ from being tracked (_much_ quicker than calling @removeMarker@ many times).
...
Returns any spiderfied markers to their original positions. You can safely call this anytime -- if no markers are spiderfied, nothing will happen.
