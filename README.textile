...
At the time of writing, compatibility with Google Maps API versions is as follows:

* *3.3 frozen* -- works fine, recommended for production.
* *3.4 feature-stable* -- doesn't respect marker z-indices, therefore not recommended.
* *3.5 nightly* -- works fine today, but may break tomorrow, therefore not recommended.
