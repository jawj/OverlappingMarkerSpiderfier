...
"click",n(function(){return this.A(a)},this)));this.b.push(a);return this};b.removeMarker=function(a){var c;a.a!=k&&this.e();a=this.o(this.b,a);if(!(a<0))return c=this.i.splice(a,1)[0],h.event.removeListener(c),this.b.splice(a,1),this};b.addListener=function(a,c){var e,d;((d=(e=this.g)[a])!=k?d:e[a]=[]).push(c);return this};b.trigger=function(){var q;var a,c,e,d,g,f;c=arguments[0];a=2<=arguments.length?p.call(arguments,1):[];q=(e=this.g[c])!=k?e:[],c=q;f=[];d=0;for(g=c.length;d<g;d++)e=c[d],f.push(e.apply(k,
