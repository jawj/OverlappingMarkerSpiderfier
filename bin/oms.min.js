...
q[l.ROADMAP]="#f00";c.h=function(){this.a=[];this.e=[]};c.addMarker=function(a){var d;d=[j.addListener(a,"click",n(function(){return this.C(a)},this))];this.l.markersWontHide||d.push(j.addListener(a,"visible_changed",n(function(){return this.j(a,!1)},this)));this.l.markersWontMove||d.push(j.addListener(a,"position_changed",n(function(){return this.j(a,!0)},this)));this.e.push(d);this.a.push(a);return this};c.j=function(a,d){if(a._omsData!=h&&(d||!a.getVisible())&&!(this.p!=h||this.r!=h))return this.H(d?
